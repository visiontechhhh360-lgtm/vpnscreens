  ...
  return (
    <div className="h-full flex flex-col relative overflow-hidden bg-background">
      ...
      >
        ...
        <p className="text-sm text-muted-foreground">Customize your VPN experience</p>
      </motion.div>

      {/* Tabs */}
      <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col min-h-0">
        <TabsList className="grid w-full grid-cols-3 mb-4 bg-card/90 backdrop-blur-sm border-2 border-border rounded-xl p-1 shadow-lg flex-shrink-0">
          <TabsTrigger
            value="general"
